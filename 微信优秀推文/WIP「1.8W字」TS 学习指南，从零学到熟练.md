...
## 「1.8W字」TS 学习指南，从零学到熟练

作者: semlinker

阿宝哥第一次使用 TypeScript 是在 Angular 2.x 项目中，那时候 TypeScript 还没有进入大众的视野。而现在学习 TypeScript 的小伙伴越来越多了，本文阿宝哥将从 **16** 个方面入手，带你一步步学习 TypeScript，感兴趣的小伙伴不要错过。
...
![img](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)![img](https://mmbiz.qpic.cn/mmbiz_png/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib153bNjzibqnYnq2dcSo7rSAbSZp8sQT9eiblVNnH8kDsA0gW9mdEGm94jQ/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVQImWNgYGBgAAAABQABh6FO1AAAAABJRU5ErkJggg==)![img](https://mmbiz.qpic.cn/mmbiz_jpg/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib15XjqXlmSJfc3T656NtXuNqvVISukJhvzKFWzghvPC2gQBJ9bom7UiaOw/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
以上代码中 **`infer R` 就是声明一个变量来承载传入函数签名的返回值类型**，简单说就是用它**取到函数返回值的类型方便之后使用**。
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib15Anb84ARaicDX98IZRv9Xn4qmpevs1PLQk4jRiabHq5RIiaAS1iapUKKjMg/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib15APMtEic2iaBBUwhLNe3IDZEZ17ib85S386UsTphJ5KI2TVA9oQoVKYibHQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib15jYkKUzGD3xPwe2u9DCjgZbCu3kkB9YbltGibL7IiciaXVQnjYzEFYMiaJQ/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_jpg/jQmwTIFl1V2pdRian6Xlm7wMdPrPspib15jqkMRmnuvxruLu0XavOnzwmDcEvUBToSaPGwyRG8wJ0mBQtGtl2z6Q/640?wx_fmt=jpeg&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

对 TypeScript ESLint 项目感兴趣且想在项目中应用的小伙伴，可以参考 “在Typescript项目中，如何优雅的使用ESLint和Prettier” 这篇文章。

能坚持看到这里的小伙伴都是 “真爱”，如果你还意犹未尽，那就来看看阿宝哥整理的 Github 上 1.8K+ 的开源项目：awesome-typescript。
